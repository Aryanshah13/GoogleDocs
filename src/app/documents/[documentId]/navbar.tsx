...
import { 
    BoldIcon,
    FileIcon, FileJson, FilePenIcon, FilePlusIcon, 
    FileTextIcon, GlobeIcon, ItalicIcon, PrinterIcon, 
    Redo2Icon, RemoveFormatting, RemoveFormattingIcon, StrikethroughIcon, TextIcon, TrashIcon, UnderlineIcon, Undo2Icon 
                                       ...
                                       <MenubarSubTrigger>
                                        ...
                                        <MenubarSubContent>
                                            <MenubarItem onClick={() => editor?.chain().focus().toggleBold().run()}>
                                                ...
                                                <span>Strikethrough&nbsp;&nbsp;</span><MenubarShortcut> Alt+K </MenubarShortcut>
                                                </MenubarItem>
                                        </MenubarSubContent>
                                    </MenubarSub>
