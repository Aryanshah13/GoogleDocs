                            ...
                            return (
                                ...
                                >
                                    {marker % 10 === 0 && (
                                        ...
                                        <span className="absoluye bottom-2 text-[10px] text-neutral-500 transform-translate-x-1/2">
                                            {marker / 10 + 1}
                                        </span>
                                        </>
                                    )}
...
const Marker = ({
    ...
    return (
    <div
    className="absolute top-0 w-4 h-full course-ew-resize z-[5] group -m2"
